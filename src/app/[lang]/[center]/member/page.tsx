            ...
            <div className="w-full flex flex-col xl:flwx-row items-start justify-center gap-2 mt-4">
                ...
                <div className="flex flex-row items-center justify-start gap-2">
                  ...
                  <button
                    ...
                    className="bg-[#bfa34a] text-sm text-[#f3f4f6] px-2 py-1 rounded-lg hover:bg-[#bfa34a]/80"
                  >
                    복사
                  </button>
                </div>
              ...
              <div className="w-full flex flex-col xl:flex-row items-center justify-between gap-5 mt-4">
                ...
                <div className="
                  ...
                  <button
                    ...
                    className={`bg-[#bfa34a] text-sm text-white px-4 py-2 rounded-lg w-full
                            ...
                            <div className="
                              ...
                              <div className="w-full flex flex-row items-center justify-between gap-2">
                                ...
                                <button
                                  ...
                                  className="w-full bg-[#bfa34a] text-sm text-white px-2 py-1 rounded-lg
                                    hover:bg-[#bfa34a]/80"
                                >
                                  보기
                                </button>
                            ...
                            <div className="w-24
                              ...
                              */}
                              ...
                              <button
                                ...
                                className={`
                                  w-full mb-2
                                  bg-[#bfa34a] text-sm text-white px-2 py-1 rounded-lg
                                  hover:bg-[#bfa34a]/80
                                `}
                              >
                                잔액 확인하기
